...
final class CloudKitSyncManager: ObservableObject {
    ...
    @Published private(set) var syncState: CloudKitSyncState = .disabled
    @Published private(set) var accountState: iCloudAccountState = .couldNotDetermine
